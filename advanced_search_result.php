...
$BT=$_POST['bodytype'];
$Colour=$_POST['colour'];
$PS=$_POST['physicalstatus'];
$Diet=$_POST['diet'];
if($Edu!=""){
	$query1="DELETE FROM temp WHERE NOT education='$Edu'";
	mysqli_query($conn,$query1);
}
if($BT!=""){
	$query1="DELETE FROM temp WHERE NOT body_type='$BT'";
	mysqli_query($conn,$query1);
}
if($Colour!=""){
	$query1="DELETE FROM temp WHERE NOT colour='$Colour'";
	mysqli_query($conn,$query1);
}
if($PS!=""){
	$query1="DELETE FROM temp WHERE NOT physical_status='$PS'";
	mysqli_query($conn,$query1);
}
if($Diet!=""){
	$query1="DELETE FROM temp WHERE NOT diet='$Diet'";
	mysqli_query($conn,$query1);
}
if($gender!=""){
...
if($Reli!=""){
	$query1="DELETE FROM temp WHERE NOT religion='$Reli'";
	mysqli_query($conn,$query1);
...
if($Div!=""){
	$query1="DELETE FROM temp WHERE NOT division='$Div'";
	mysqli_query($conn,$query1);
}
if($lan!=""){
...
echo"<p STYLE='font-size:25px; color:blue;' ><b> Total ". $cnt . " Results Found.</p>";
mysqli_free_result($result);
}
else
{
	echo"<p STYLE='font-size:25px; color:blue;' ><b> No Result Found.</p>";
}
}
else
echo"query not runned";
